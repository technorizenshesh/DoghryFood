 ...
 */
public class FavRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public FavRecyclerViewAdapter(Context context, ArrayList<DiscoversModel> modelList, Fragment fragment) {
