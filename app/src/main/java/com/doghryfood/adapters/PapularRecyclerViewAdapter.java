 ...
 */
public class PapularRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public PapularRecyclerViewAdapter(Context context, ArrayList<DiscoversModel> modelList, Fragment fragment) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        //View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_papular, viewGroup, false);
