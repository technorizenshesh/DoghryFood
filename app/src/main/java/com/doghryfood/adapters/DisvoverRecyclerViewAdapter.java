 ...
 */
public class DisvoverRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public DisvoverRecyclerViewAdapter(Context context, ArrayList<DiscoversModel> modelList, Fragment fragment) {
