...
public class CardRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public CardRecyclerViewAdapter(Context context, ArrayList<DiscoversModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_pament_card, viewGroup, false);
